    ...
    >
      ...
      <section className="py-8 sm:py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className={`text-center font-bold text-navy-800 text-base sm:text-lg mb-6 ${isAr ? 'font-arabic' : ''}`}>
          ...
          <div className="overflow-x-auto pb-2">
            <div
              className={`flex items-center gap-1 sm:gap-2 min-w-max mx-auto ${isAr ? 'flex-row-reverse' : 'flex-row'}`}
      ...
      <section className="py-4 px-4 border-t border-navy-100">
        <div className="max-w-3xl mx-auto">
          <h2 className={`text-center font-bold text-navy-800 text-sm sm:text-base mb-4 ${isAr ? 'font-arabic' : ''}`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 text-xs sm:text-sm text-center">
            {(isAr
              ...
              <div
                key={role}
                className={`bg-navy-50 border border-navy-200 rounded-lg px-2 py-2 text-navy-800 font-semibold ${isAr ? 'font-arabic' : ''}`}
              >
                {role}
              </div>
            ))}
